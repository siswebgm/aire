            ...
            {loading ? (
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                <div className="hidden md:grid grid-cols-12 gap-3 px-4 sm:px-5 py-3 bg-slate-50/70 border-b border-slate-200/70 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                  ...
                  <div className="col-span-1 lg:col-span-2">WhatsApp</div>
                  <div className="col-span-3 lg:col-span-2 text-right">Tipo</div>
                </div>
                  ...
                  {moradoresFiltrados.map((m) => {
                    ...
                    return (
                      <div
                        ...
                        className="px-4 sm:px-5 py-4 hover:bg-slate-50/60 transition-colors cursor-pointer"
                      >
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-start">
                          <div className="flex items-start gap-3 md:col-span-1">
                            <div className="w-12 h-12 md:w-10 md:h-10 rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden flex items-center justify-center">
                              {m.facial_url ? (
                                // eslint-disable-next-line @next/next/no-img-element
                                <img src={m.facial_url} alt={`Facial de ${m.nome}`} className="w-full h-full object-cover" />
                              ) : (
                          ...
                          <div className="hidden md:flex md:col-span-2 items-center text-sm text-slate-700 min-w-0">
                            {m.bloco ? m.bloco : '—'}
                          </div>

                          <div className="hidden md:flex md:col-span-1 items-center text-sm text-slate-700 min-w-0">
                            {m.apartamento}
                          </div>
                          ...
                          <div className="md:col-span-1 lg:col-span-2 min-w-0">
                            {whatsappStr ? (
                              <a
                                ...
                                className="inline-flex items-center gap-2 text-sm font-semibold text-emerald-700 hover:underline max-w-full min-w-0"
                              >
                                <Phone size={16} />
                                <span className="truncate hidden lg:inline">{whatsappStr}</span>
                              </a>
                            ) : (
                          ...
                          <div className="md:col-span-3 lg:col-span-2 md:text-right min-w-0">
                            <div className="flex items-center justify-end gap-2 flex-wrap">
                              <span
                                className="inline-flex text-xs font-bold px-2.5 py-1 rounded-lg border max-w-[140px] truncate whitespace-nowrap"
                                style={{
                              ...
                              <div className="relative">
                                <button
                                  ...
                                  className="shrink-0 inline-flex items-center justify-center w-9 h-9 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-600"
                                  aria-label="Ações"
                                >
